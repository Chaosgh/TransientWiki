...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/",
    languages: { "de-DE": "/de/", "en-US": "/en/", "x-default": "/" },
  },
};
      ...
      <section className={styles.card} aria-labelledby="language-title">
        ...
        <div className={styles.choices}>
          <Link href="/de/" hrefLang="de" lang="de">
            <span>DE</span><strong>Deutsch</strong><small>Das Realm betreten →</small>
          </Link>
          <Link href="/en/" hrefLang="en" lang="en">
            <span>EN</span><strong>English</strong><small>Enter the Realm →</small>
          </Link>
        </div>
